...
namespace MoneyTree.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Created,Updated,Balance,HouseholdId")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Created,Updated,Balance,HouseholdId")] Account account)
        {
            if (ModelState.IsValid)
            {
